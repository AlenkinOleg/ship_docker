...
if charm == 0: 
    ship_geo = ConfigRegistry.loadpy("$FAIRSHIP/macro/my_geometry_config.py", Yheight = dy, tankDesign = dv,\
                                                muShieldDesign = ds, nuTauTargetDesign=nud)
else: 
    ship_geo = ConfigRegistry.loadpy("$FAIRSHIP/macro/my_charm-geometry_config.py")
